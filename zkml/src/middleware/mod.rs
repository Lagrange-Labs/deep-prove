...
use super::{Element, Proof, model::Model, quantization::ModelMetadata};

/// A type of the proof for the `v1` of the protocol
pub type ProofV1 = Proof<GoldilocksExt2, Basefold<GoldilocksExt2, BasefoldRSParams>>;
...
#[derive(Serialize, Deserialize)]
pub struct DeepProveResponseV1 {
    pub proofs: Vec<ProofV1>,
}
